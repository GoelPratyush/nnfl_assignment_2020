...
class MultiHeadAttention(nn.Module):
    def __init__(self, hid_dim, n_heads = 16):
        """
...
class PositionFeedforward(nn.Module):
    ...
    def get_layers(self, hid_dim, feedForward_dim): # 0.5 Mark
        ...
        # conv2 = nn.Conv1d(feedForward_dim, hid_dim, kernel_size = 1, stride = 1, padding=1)
        conv2 = nn.Conv1d(feedForward_dim, hid_dim, kernel_size = 1)
        return [conv1, conv2]